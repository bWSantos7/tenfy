...
urlpatterns = [
    ...
    path('checkout/pending/pix/',        views.checkout_pending_pix,     name='billing_checkout_pending_pix'),
    path('checkout/pending/session/',    views.checkout_pending_session, name='billing_checkout_pending_session'),
