      ...
      <header className="sticky top-0 z-50 w-full bg-bg-card/75 backdrop-blur-md border-b border-border-subtle transition-all duration-300">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <Link to={isAuthenticated ? '/inicio' : '/'} className="flex items-center group">
            <img src="/logos/logo_clara.png" alt="Tenfy" className="h-11 sm:h-12 w-auto object-contain transition-transform duration-300 group-hover:scale-105 dark:hidden" />
            <img src="/logos/logo_escura.png" alt="Tenfy" className="h-11 sm:h-12 w-auto object-contain transition-transform duration-300 group-hover:scale-105 hidden dark:block" />
          </Link>
